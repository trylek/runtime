            ...
            using (PerfEventSource.StartStopEvents.CompilationEvents())
            {
                ...
                using (PerfEventSource.StartStopEvents.LoadingEvents())
                {
                    ...
                    builder
                        ...
                        .UseCodeAlignment(_commandLineOptions.CodeAlignment)
                        .UseCodeSectionPadding(_commandLineOptions.CodeSectionPadding)
                        .UseMethodHoopCount(_commandLineOptions.PerfMethodHoopCount)
