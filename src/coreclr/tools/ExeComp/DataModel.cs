...
namespace ExeComp
{
...

    {
        ...
        public InstructionSequence Negated()
        {
            return new InstructionSequence() { Count = -Count, Bytes = -Bytes };
        }
        ...
        bool IEquatable<InstructionSequence>.Equals(InstructionSequence sequence)
        {
            return sequence.Count == this.Count && sequence.Bytes == this.Bytes;
        }
    ...
    public struct ModuleSymbol : IEquatable<ModuleSymbol>
    {
        ...
        bool IEquatable<ModuleSymbol>.Equals(ModuleSymbol moduleSymbol)
        {
            return Module == moduleSymbol.Module && Symbol == moduleSymbol.Symbol;
        }
    }
    ...
    public sealed class ThreadExecution
    {
